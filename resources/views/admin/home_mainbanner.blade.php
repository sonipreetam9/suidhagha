                                ...
                                <div class="card">
                                    ...
                                    <div class="card-block table-border-style">
                                        ...
                                        <form method="post" enctype="multipart/form-data"
                                            action="{{ route('adm.insert.mainbanner') }}">
                                            @csrf
                                            @method('POST')
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="form-label" for="cin">Select Type</label>
                                                        <select name="type" id="cin" class="form-control" required>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="category_id" id="ci" class="form-control"
                                                            required>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="user-icon">
                                                                ...
                                                                <img src="{{ asset('uploads/Main Bannner/'.$list->image) }}"
                                                                    style="height: 50px; width: 50px;">

                                                            </div>
                                                        </td>
                                                        <td>
                                                            @if($list->type == "desktop")
                                                            <span class="badge bg-success">Desktop</span>
                                                            @elseif($list->type== "mobile")
                                                        ...
                                                        <td>
                                                            <button type="button" class="btn btn-sm btn-primary"
                                                                ...
                                                                data-bs-target="#gridSystemModal{{ $list->id }}">Update</button>
                                                            <div id="gridSystemModal{{ $list->id }}" class="modal fade"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form method="post"
                                                                                ...
                                                                                action="{{ route('adm.update.main.banner', ['id' => $list->id]) }}">
                                                                                @csrf
                                                                                @method('POST')
                                                            ...
                                                            <form method="post"
                                                                action="{{ route('adm.del.main.banner', ['id' => $list->id]) }}"
