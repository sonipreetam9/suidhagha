                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">All Sub Categories</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home /</a></li>
                                    <li class="breadcrumb-item"><a href="#">All
                                            Sub Categories</a></li>
                                </ul>
                            </div>
                        </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="user-icon">
                                                                ...
                                                                <img src="{{ asset('uploads/sub-categories-images/'.$category->logo) }}"
                                                        ...
                                                        <td>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form method="post"
                                                                                ...
                                                                                action="{{ route('adm.sub.update.category',['id'=> $category->id]) }}">
                                                                                @csrf
                                                                                @method('POST')
                                                                                <div class="row">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data"
                                                                action="{{ route('adm.del.category',['id'=> $category->id]) }}"
