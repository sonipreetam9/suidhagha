                        ...
                        <div class="row align-items-center">
                            <div class="col-md-12">
                                <div class="page-header-title">
                                    <h5 class="m-b-10">Home Last Banner</h5>
                                </div>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home /</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('adm.main.banner') }}">Home Last
                                            Banner</a></li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Add Homepage Last Banner</h5>
                                    </div>
                                    <div class="card-block table-border-style">
                                        ...
                                        <form method="post" enctype="multipart/form-data" action="{{ route('adm.insert.lastbanner') }}">
                                            @csrf
                                            @method('POST')
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="user-icon">
                                                                ...
                                                                <img src="{{ asset('uploads/Last Banner/'.$list->image) }}" style="height: 50px; width: 50px;">
                                                        ...
                                                        <td>
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form method="post" enctype="multipart/form-data" action="{{ route('adm.update.last.banner', ['id' => $list->id]) }}">
                                                                                @csrf
                                                                                @method('POST')
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-4 col-xs-12">
                                                                                        <div class="form-group">
                                                                                            <img src="{{ asset('uploads/Last Banner/'.$list->image) }}" style="width: 100px; height: 100px;">
                                                            ...
                                                            <form method="post" action="{{ route('adm.del.last.banner', ['id' => $list->id]) }}" onsubmit="return confirm('Are you sure you want to delete this banner?')">
                                                                @csrf
                                                                @method('POST')
