            ...
            <div class="row">
                    ...
                    <div class="about__thumb d-flex">
                        <div class="about__thumb--items">
                            <img class="about__thumb--img border-radius-5 display-block"
                                src="{{ asset('uploads/Products Images/IMG-20240430-WA0013.jpg') }}" alt="about-thumb">
                        </div>
                        <div class="about__thumb--items position__relative">
                            <img class="about__thumb--img border-radius-5 display-block"
                                src="{{ asset('uploads/Products Images/IMG-20240430-WA0011.jpg') }}" alt="about-thumb">
                ...
                <div class="col-lg-6">
                    <div class="about__content">
                        ...
                        <h2 class="about__content--maintitle mb-25">Explore Our Exquisite Collection</h2>
                        <p class="about__content--desc mb-20">Why Choose {{ $comp_name }}? Because we're more than just
                            a destination for ethnic wear; we're a celebration of Indian heritage and style. With a
                            commitment to quality, authenticity, and customer satisfaction, we bring you meticulously
                            crafted kurtas and suits that effortlessly blend tradition with modernity. Our curated
                            collection ensures you'll find the perfect ensemble for any occasion, whether it's a festive
                            celebration, a formal event, or a casual outing with friends. From vibrant colors to
                            intricate designs, each garment tells a story of rich cultural heritage and impeccable
                            craftsmanship. But our dedication doesn't stop there. We understand that shopping for ethnic
                            wear can sometimes be overwhelming, which is why our dedicated customer support team is here
                            to guide you every step of the way. Whether you need assistance with sizing, styling advice,
                            or tracking your order, we're always just a message or a call away. And with our seamless
                            shopping experience, including secure payment options and speedy delivery, you can shop with
                            confidence, knowing that your satisfaction is our top priority. Experience the essence of
                            Indian elegance with {{ $comp_name }} today, and let us be your trusted partner in exploring
                            the beauty of traditional attire.</p>
                        {{-- <p class="about__content--desc mb-25">Itaque accusantium eveniet a laboriosam dolorem?
                            Magni suscipit est corrupti explicabo non perspiciatis, excepturi ut asperiores assumenda
