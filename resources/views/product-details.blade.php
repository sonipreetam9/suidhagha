                                ...
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        ...
                                        <div class="product__media--view__icon">
                                            @if($product && $product->image2 != null)
                                            <a class="product__media--view__icon--link glightbox"
                                                href="{{ asset('uploads/Products Images/'.$product->image2) }}"
                                                data-gallery="product-media-preview">
                                            ...
                                            @endif
                                            @if($product && $product->image3 != null)
                                            <a class="product__media--view__icon--link glightbox"
                                                href="{{ asset('uploads/Products Images/'.$product->image3) }}"
                                                data-gallery="product-media-preview">
                                                <svg class="product__media--view__icon--svg"
                                                    xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443"
                                                    viewBox="0 0 512 512">
                                            ...
                                            @endif
                                            @if($product && $product->image4 != null)
                                            <a class="product__media--view__icon--link glightbox"
                                                href="{{ asset('uploads/Products Images/'.$product->image4) }}"
                                                data-gallery="product-media-preview">
                                                <svg class="product__media--view__icon--svg"
                                                    xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443"
                                                    viewBox="0 0 512 512">
                                            ...
                                            @endif
                                            @if($product && $product->image5 != null)
                                            <a class="product__media--view__icon--link glightbox"
                                                href="{{ asset('uploads/Products Images/'.$product->image5) }}"
                                                data-gallery="product-media-preview">
                                                <svg class="product__media--view__icon--svg"
                                                    xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443"
                                                    viewBox="0 0 512 512">
