                                ...
                                <div class="row row-cols-1">
                                    <div class="col">
                                        <div class="slider__content">
                                            ...
                                            <a class="slider__btn primary__btn" href="{{ route('shop.page') }}">Show
                                                Collection
                                    ...
                                    <div class="hero__slider--items__inner">
                                        <div class="slider__content">
                                            ...
                                            <p class="slider__content--desc desc2 d-sm-2-none mb-40 ">Up To 40% Off
                                                Final Sale Items. <br>
                                                Caught in the Moment!</p>
                                            <a class="primary__btn slider__btn" href="{{ route('shop.page') }}">Show
                                                Collection
                        ...
                        <div class="product__items ">
                            <div class="product__items--thumbnail">
                                <a class="produSct__items--link"
                                    ...
                                    <img class="product__items--img product__primary--img"
                                        src="{{ asset('uploads/Products Images/'.$product->image) }}" alt="product-img" style="height: 280px">
                                    <img class="product__items--img product__secondary--img"
                ...
                <div class="col">
                    <div class="banner__section--inner position__relative">
                        <a class="banner__items--thumbnail display-block" href="#"><img
                                ...
                                src="{{ asset('uploads/Last Bannner/'.$lastbanners->image) }}" alt="banner-img" style="width: 100%">
