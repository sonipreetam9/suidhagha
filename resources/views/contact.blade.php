...
<main class="main__content_wrapper">
                ...
                <div class="col">
                    <div class="breadcrumb__content text-center">
                        ...
                        <ul class="breadcrumb__content--menu d-flex justify-content-center">
                            <li class="breadcrumb__content--menu__items"><a class="text-white" href="{{ route('contact.page') }}">Home</a></li>
        ...
        <div class="container">
            ...
            <div class="main__contact--area position__relative">
                ...
                <div class="contact__form">
                    ...
                    <form class="contact__form--inner" action="{{ route('contact.page.post') }}" method="POST">
                        @csrf
                        @if (session('success'))
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    ...
                                    <input class="contact__form--input" name="first_name" id="input1" placeholder="Your First Name" type="text" value="{{ old('first_name') }}">
                                    @error('first_name')
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    <label class="contact__form--label" for="input2">Last Name </label>
                                    <input class="contact__form--input" name="last_name" id="input2" placeholder="Your Last Name" type="text" value="{{ old('last_name') }}">
                                    @error('last_name')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    ...
                                    <input class="contact__form--input" name="phone" id="input3" placeholder="Phone number" type="number" value="{{ old('phone') }}">
                                    @error('phone')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="contact__form--list mb-20">
                                    ...
                                    <input class="contact__form--input" name="email" id="input4" placeholder="Email" type="email" value="{{ old('email') }}">
                                    @error('email')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                ...
                <div class="contact__info border-radius-5">
                    ...
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white"> <a href="mailto:{{ $comp_email }}">{{ $comp_email }}</a> <br> <a href="{{ $comp_email1 }}">{{ $comp_email1 }}</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
                        ...
                        <div class="contact__info--items__inner d-flex">
                            ...
                            <div class="contact__info--content">
                                <p class="contact__info--content__desc text-white">{{ $comp_address }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="contact__info--items">
    ...
    <div class="contact__map--area section--padding pt-0">
        ...
        <iframe class="contact__map--iframe" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d44786.796356246785!2d72.36769361384316!3d22.920228143424914!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e973b77bdf381%3A0xa5bef43eae036221!2sMoraiya%2C%20Gujarat%20382213!5e1!3m2!1sen!2sin!4v1729928357924!5m2!1sen!2sin" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
